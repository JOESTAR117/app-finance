...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { data: @movement.data, description: @movement.description, type: @movement.type, value: @movement.value } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { data: @movement.data, description: @movement.description, type: @movement.type, value: @movement.value } }
